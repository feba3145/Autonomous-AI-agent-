...
def login(body: LoginRequest):
    ...
    if body.session_id in session_store:
    ...
    return {
        ...
        "message": "Welcome back " + firstname + "! You are now logged in."
    }
...
def auth_status(session_id: str):
    ...
    return {"session_id": session_id, "logged_in": logged_in, "customer_id": customer_id}
